...
#print(aprs_callsign + '>APRS,TCPIP*:' + '=' + latitude + '/' + longitude + '</A' + altitude + ' ' + aprs_comment)

AIS.set_filter(aprs_filter)
AIS.connect()

    #AIS.sendall("user " + aprs_callsign + " pass " + aprs_passcode + " vers APRSlib filter m/100 r/47.436/-120.327/100")
